...
namespace CommandManagementSystem
{
    ...
    public abstract class Command<TParameter, TOut> : ICommand<TParameter, TOut>
    {
        ...
        /// <param name="arg">Parameters to be passed</param>
        /// <returns>Returns a fixed return value</returns>
        public virtual TOut Initialize(TParameter arg)
            => Dispatch(arg);
        ...
        public virtual void RaiseFinishEvent(object sender, TParameter arg)
            => FinishEvent?.Invoke(sender, arg);
        ...
        public virtual void RaiseWaitEvent(object sender, Func<TParameter, TOut> arg)
            => WaitEvent?.Invoke(sender, arg);
